          ...
          {displayBangles.map((bangle, index) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden bg-zinc-900/5 transition-all duration-500 border border-zinc-200 group-hover:border-zinc-400 rounded-sm shine-effect">
                ...
                <div className="absolute inset-0 bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center z-20">
                  <span className="text-[10px] uppercase tracking-[0.4em] border border-gray-300 px-8 py-4 instant-blur text-white">
                    View Masterpiece
                  </span>
                </div>
              </div>
