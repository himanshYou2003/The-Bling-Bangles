...
export default function BangleDetail() {
  ...
  const bangle = {
    ...
    price: dataToUse?.price || staticBangleData?.price || 999
  };
          ...
          <div className="relative h-[500px] lg:h-[600px]">
            ...
            <div className="grid grid-cols-2 gap-y-10 gap-x-6">
              {[
                ...
                { label: 'Material', value: '24 Carat Gold (Artificial)' },
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {suggestedBangles.map((item) => (
            ...
            >
              ...
              <p className="text-brand-gold text-[10px] uppercase tracking-[0.2em]">{item.type || item.category} • {item.material || 'Premium'}</p>
            </motion.div>
          ))}
        </div>
      </section>
